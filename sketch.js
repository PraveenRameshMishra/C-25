...
function setup() {
	...
	paper= Bodies.circle(120,40,radius/)
...
function draw() {
   ...
   paperImg(ball.position.x,paper.position.y,radius,radius);
   image(120,20,100,100);

  
		
     dustbinImg(dustbin.position.x,dustbin.position.y,radius,radius);       
